...
/**
 * Log creation script for the Kaltura media resource.
 *
...
/**
 * Callback function for Kaltura media resource.
 ...
 */
function course_kalmediares(array $config, $cmid, $name, $lang) {
    return [
        'id' => $config['app_url'].'/mod/kalmediares/view.php?id='.$cmid,
        'definition' => [
