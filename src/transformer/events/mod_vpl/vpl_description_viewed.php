...
/**
 * This function creates vpl description viewed log about VPL module.
 ...
 */
function vpl_description_viewed(array $config, \stdClass $event) {
    $repo = $config['repo'];
    ...
    return [[
        ...
        'verb' => [
            'id' => 'http://activitystrea.ms/schema/1.0/view',
            'display' => [
                $lang => 'submission description viewed'
            ],
        ],
