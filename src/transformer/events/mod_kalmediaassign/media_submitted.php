...
/**
 * This function creates media submitted log about Kaltura media assignment module.
 ...
 */
function media_submitted(array $config, \stdClass $event) {
    $repo = $config['repo'];
    $user = $repo->read_record_by_id('user', $event->userid);
    $course = $repo->read_record_by_id('course', $event->courseid);
    $submission = $repo->read_record_by_id('kalmediaassign_submission', $event->objectid);
    $assignment = $repo->read_record_by_id('kalmediaassign', $submission->mediaassignid);
