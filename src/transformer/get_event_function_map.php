...
/**
 * Mapping file for event callback functions.
 *
...
/**
  This function creates combinations of Moodle events and callback functions.
  @return array - array of callback functions.
*/
function get_event_function_map() {
    $availableevents = [
        ...
        '\mod_kalmediaassign\event\grades_updated' => 'mod_kalmediaassign\grades_updated',
        '\mod_kalmediaassign\event\media_submitted' => 'mod_kalmediaassign\media_submitted',
        '\mod_kalmediares\event\media_resource_viewed' => 'mod_kalmediares\media_resource_viewed',
        '\mod_kalmediares\event\media_resource_played' => 'mod_kalmediares\media_resource_played',
        ...
        '\mod_questionnaire\event\attempt_submitted' => 'mod_questionnaire\attempt_submitted\handler',
        ...
        '\mod_vpl\event\submission_debugged' => 'mod_vpl\submission_debugged',
        '\mod_vpl\event\submission_edited' => 'mod_vpl\submission_edited',
        '\mod_vpl\event\submission_evaluated' => 'mod_vpl\submission_evaluated',
        '\mod_vpl\event\submission_grade_updated' => 'mod_vpl\submission_grade_updated',
        '\mod_vpl\event\submission_run' => 'mod_vpl\submission_run',
        '\mod_vpl\event\submission_uploaded' => 'mod_vpl\submission_uploaded',
        '\mod_vpl\event\vpl_description_viewed' => 'mod_vpl\vpl_description_viewed',
        ...
        '\mod_workshop\event\assessment_evaluated' => 'mod_workshop\assessment_evaluated',
        '\mod_workshop\event\assessment_reevaluated' => 'mod_workshop\assessment_reevaluated',
