...
/**
 * This function creates answer log about numeric item.
 ...
 * @param string $tablename - question table name.
 ...
 */
function numeric(array $config, \stdClass $event, \stdClass $question, $tablename, $responseid, \stdClass $questionnaire) {
    $repo = $config['repo'];
    ...
    return [[
        ...
        'result' => [
            ...
            'extensions' => [
                'http://learninglocker.net/xapi/cmi/numeric/response' => floatval($choicenum),
            ],
        ],
        'context' => [
