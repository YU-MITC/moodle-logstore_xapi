...
/**
 * This function creates answer log about dateresp item.
 ...
 */
function dateresp(array $config, \stdClass $event, \stdClass $question, $tablename, $responseid, \stdClass $questionnaire) {
    $repo = $config['repo'];
    ...
    return [[
        ...
        'result' => [
            ...
            'extensions' => [
                'http://learninglocker.net/xapi/cmi/numeric/response' => $choicelabel,
            ],
        ],
        'context' => [
