...
/**
 * This function creates answer log about resptext item.
 ...
 */
function resptext(array $config, \stdClass $event, \stdClass $question, $tablename, $responseid, \stdClass $questionnaire) {
    $repo = $config['repo'];
    ...
    if (!empty($choice)) {
        $choicetext = utils\get_string_html_removed(trim($choice[0]->response));
    }
    ...
    return [[
        ...
        'result' => [
            ...
            'extensions' => [
                'http://learninglocker.net/xapi/cmi/fill-in/response' => $choicetext,
            ],
        ],
        'context' => [
