...
/**
 * This function creates assessment reevaluated log about workshop module.
 ...
 */
function assessment_reevaluated(array $config, \stdClass $event) {
    $repo = $config['repo'];
    ...
    $statement = [
        ...
        'verb' => [
            ...
            'display' => [
                $lang => 'reevaluated assesment for'
            ],
        ],
