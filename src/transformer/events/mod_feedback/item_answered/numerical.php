...
function numerical(array $config, \stdClass $event, \stdClass $feedbackvalue, \stdClass $feedbackitem) {
    ...
    if (!empty($feedbackvalue)) {
        $responsevalue = floatval($feedbackvalue->value);
    }
    ...
    return [[
        ...
        'result' => [
            ...
            'completion' => !empty($feedbackvalue->value) && $feedbackvalue->value !== '',
            'extensions' => [
                'http://learninglocker.net/xapi/cmi/numeric/response' => $responsevalue,
            ],
        ],
        'context' => [
