...
/**
 * This function creates module viewed log about questionnaire module.
...
function course_module_viewed(array $config, \stdClass $event) {
    ...
    return [[
        ...
        'object' => utils\get_activity\course_questionnaire($config, $course, $event->contextinstanceid),
