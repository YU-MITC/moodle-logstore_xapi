...
/**
 * This function creates reassessed log about workshop module.
 ...
 */
function submission_reassessed(array $config, \stdClass $event) {
    $repo = $config['repo'];
    ...
    foreach($grades as $grade) {
        ...
        $gradestatement .= '{id: ' . $grade->dimensionid . ', grade: ' . $grade->grade;
